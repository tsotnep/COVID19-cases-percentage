...
graphImgPath="../img2_Inf_Dead_Recov_Percentage.png"
...
rects3=ax.bar(x_pos+0.0, cases['activ_pop'],                        width=0.2, align='center', color='blue'  , label='active cases % of population')
